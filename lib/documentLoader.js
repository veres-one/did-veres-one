...
const jsonldPatchContext = require('./contexts/json-ld-patch-context');
const veresOneContext = require('./contexts/veres-one-context');
const webLedgerContext = require('./contexts/web-ledger-context');
const didContext = require('./contexts/did-context');
