module.exports =  {
  "@context": {
    ...
    "basisBlockHeight": "wl:basisBlockHeight",
    ...
    "consensusProofHash": {"@id": "wl:consensusProofHash", "@container": "@set"},
    "controller": {"@id": "sec:controller", "@type": "@id"},
    "created": {"@id": "dc:created", "@type": "xsd:dateTime"},
    "creator": {"@id": "dc:creator", "@type": "@id"},
    "defaultElector": {"@id": "wl:defaultElector", "@type": "@id", "@container": "@set"},
    "delegator": {"@id": "sec:delegator", "@type": "@id"},
    "digestAlgorithm": "sec:digestAlgorithm",
    "digestValue": "sec:digestValue",
    "domain": "sec:domain",
    "elector": {"@id": "wl:elector", "@type": "@id"},
    "electorSelectionMethod": {"@id": "wl:electorSelectionMethod", "@type": "@id"},
    "electorPool": {"@id": "wl:electorPool", "@type": "@id"},
    ...
    "operationHash": {"@id": "wl:operationHash", "@container": "@set"},
    ...
    "sequence": {"@id": "jldp:sequence", "@type": "xsd:integer"},
    "targetNode": {"@id": "wl:targetNode", "@type": "@id"},
